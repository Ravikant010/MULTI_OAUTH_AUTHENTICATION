...
const redirectURI = "https://multi-oauth-authentication-nextjs.vercel.app/login/google/callback";
export const google = new Google(env.GOOGLE_CLIENT_ID, env.GOOGLE_CLIENT_SECRET, redirectURI)

export const twitter = new Twitter(env.GITHUB_CLIENT_ID, env.GITHUB_CLIENT_SECRET, "https://multi-oauth-authentication-nextjs.vercel.app/login/twitter/callback");
